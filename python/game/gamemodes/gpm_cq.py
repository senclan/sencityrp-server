...
SCORE_CAPTURE = 0
SCORE_NEUTRALIZE = 0
SCORE_CAPTUREASSIST = 0
SCORE_NEUTRALIZEASSIST = 0
SCORE_DEFEND = 0
...
sbx = sandboxCore.start()
sbx.initSbx()
sbx.disableBoundaries()
sbx.setMinPlayers(1)'''

from sbxGame_build import *
...
def onGameStatusChanged(status):
	...
	if status == bf2.GameStatus.Playing:
		...
		bf2.gameLogic.setTickets(1, 999)
		bf2.gameLogic.setTickets(2, 999)
